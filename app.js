/*!jQuery v3.4.1 | (c) JS Foundation and other contributors | jquery.org/license*/!(function(e,t){"use strict";"object"==typeof module&&"object"==typeof module.exports?(module.exports=e.document?t(e,!0):function(e){if(!e.document)
...
")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+
W+
")*)|.*)\\)|)",F=new RegExp(M+"+","g"),B=new RegExp("^"+M+"+|((?:^|[^\\\\])(?:\\\\.)*)"+M+"+$","g"),_=new RegExp("^"+M+"*,"+M+"*"),z=new RegExp("^"+M+"*([>+~]|"+M+")"+M+"*"),U=new RegExp(M+"|>"),X=new RegExp($),V=new RegExp("^"+I+"$"),G={ID:new RegExp("^#("+I+")"),CLASS:new RegExp("^\\.("+I+")"),TAG:new RegExp("^("+I+"|[*])"),ATTR:new RegExp("^"+W),PSEUDO:new RegExp("^"+$),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+
M+
"*(even|odd|(([+-]|)(\\d*)n|)"+
M+
"*(?:([+-]|)"+
...
"*(\\d+)|))"+
M+
"*\\)|)","i"),bool:new RegExp("^(?:"+R+")$","i"),needsContext:new RegExp("^"+
M+
"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+
M+
"*((?:-\\d)?\\d*)"+
M+
"*\\)|)(?=[^-]|$)","i"),},Y=/HTML$/i,Q=/^(?:input|select|textarea|button)$/i,J=/^h\d$/i,K=/^[^{]+\{\s*\[native \w/,Z=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,ee=/[+~]/,te=new RegExp("\\\\([\\da-f]{1,6}"+M+"?|("+M+")|.)","ig"),ne=function(e,t,n){var r="0x"+t-65536;return r!=r||n?t:r<0?String.fromCharCode(r+65536):String.fromCharCode((r>>10)|55296,(1023&r)|56320);},re=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,ie=function(e,t){return t?"\0"===e?"\ufffd":e.slice(0,-1)+
"\\"+
...
return t.getElementsByClassName(e);}),(s=[]),(v=[]),(d.qsa=K.test(C.querySelectorAll))&&(ce(function(e){(a.appendChild(e).innerHTML="<a id='"+
k+
"'></a><select id='"+
k+
...
(c=p[o]),(!i&&g!==c.origType)||(n&&n.guid!==c.guid)||(s&&!s.test(c.namespace))||(r&&r!==c.selector&&("**"!==r||!c.selector))||(p.splice(o,1),c.selector&&p.delegateCount--,f.remove&&f.remove.call(e,c));a&&!p.length&&((f.teardown&&!1!==f.teardown.call(e,h,v.handle))||k.removeEvent(e,d,v.handle),delete u[d]);}else for(d in u)k.event.remove(e,d+t[l],n,r,!0);k.isEmptyObject(u)&&Q.remove(e,"handle events");}},dispatch:function(e){var t,n,r,i,o,a,s=k.event.fix(e),u=new Array(arguments.length),l=(Q.get(this,"events")||{})[s.type]||[],c=k.event.special[s.type]||{};for(u[0]=s,t=1;t<arguments.length;t++)u[t]=arguments[t];if(((s.delegateTarget=this),!c.preDispatch||!1!==c.preDispatch.call(this,s))){(a=k.event.handlers.call(this,s,l)),(t=0);while((i=a[t++])&&!s.isPropagationStopped()){(s.currentTarget=i.elem),(n=0);while((o=i.handlers[n++])&&!s.isImmediatePropagationStopped())
...
return(((!y.boxSizingReliable()&&i)||"auto"===a||(!parseFloat(a)&&"inline"===k.css(e,"display",!1,r)))&&e.getClientRects().length&&((i="border-box"===k.css(e,"boxSizing",!1,r)),(o=s in e)&&(a=e[s])),(a=parseFloat(a)||0)+
...
parseFloat(i[u])-
et(e,u,"border",!1,i)-
0.5)),s&&(r=ne.exec(t))&&"px"!==(r[3]||"px")&&((e.style[u]=t),(t=k.css(e,u))),Ze(0,t,s));},};}),(k.cssHooks.marginLeft=ze(y.reliableMarginLeft,function(e,t){if(t)
return((parseFloat(_e(e,"marginLeft"))||e.getBoundingClientRect().left-
ue(e,{marginLeft:0},function(){return e.getBoundingClientRect().left;}))+"px");})),k.each({margin:"",padding:"",border:"Width"},function(i,o){(k.cssHooks[i+o]={expand:function(e){for(var t=0,n={},r="string"==typeof e?e.split(" "):[e];t<4;t++)
...
k.each(e,function(e,t){r||Nt.test(n)?i(n,t):qt(n+"["+("object"==typeof t&&null!=t?e:"")+"]",t,r,i);});else if(r||"object"!==w(e))i(n,e);else for(t in e)qt(n+"["+t+"]",e[t],r,i);}
(k.param=function(e,t){var n,r=[],i=function(e,t){var n=m(t)?t():t;r[r.length]=encodeURIComponent(e)+"="+encodeURIComponent(null==n?"":n);};if(null==e)return "";if(Array.isArray(e)||(e.jquery&&!k.isPlainObject(e)))
...
("*"!==v.dataTypes[0]?", "+$t+"; q=0.01":""):v.accepts["*"]),v.headers))
...
return((r=s.call(arguments,2)),((i=function(){return e.apply(t||this,r.concat(s.call(arguments)));}).guid=e.guid=e.guid||k.guid++),i);}),(k.holdReady=function(e){e?k.readyWait++:k.ready(!0);}),(k.isArray=Array.isArray),(k.parseJSON=JSON.parse),(k.nodeName=A),(k.isFunction=m),(k.isWindow=x),(k.camelCase=V),(k.type=w),(k.now=Date.now),(k.isNumeric=function(e){var t=k.type(e);return("number"===t||"string"===t)&&!isNaN(e-parseFloat(e));}),"function"==typeof define&&define.amd&&define("jquery",[],function(){return k;});var Qt=C.jQuery,Jt=C.$;return((k.noConflict=function(e){return C.$===k&&(C.$=Jt),e&&C.jQuery===k&&(C.jQuery=Qt),k;}),e||(C.jQuery=C.$=k),k);});if(UI.dark_mode){document.write('<meta name="theme-color" content="#273139">');}
if(UI.dark_mode){document.write('<link rel="stylesheet" href="//raw.githack.com/curious-harshit/IBGIndex/main/css/mdui_v2_dark.min.css">');}else{document.write('<link rel="stylesheet" href="//raw.githack.com/curious-harshit/IBGIndex/main/css/mdui_v2.min.css">');}
if(UI.dark_mode){document.write('<link rel="stylesheet" href="//raw.githack.com/curious-harshit/IBGIndex/main/css/nexmoe_v2_dark.min.css">');}else{document.write('<link rel="stylesheet" href="//raw.githack.com/curious-harshit/IBGIndex/main/css/nexmoe_v2.min.css">');}
document.write('<script src="//rawcdn.githack.com/curious-harshit/IBGIndex/8f3a8827f03823ba4e8ea2f340c03066f185dd54/js/mdui.min.js"></script>');document.write('<script src="//rawcdn.githack.com/curious-harshit/IBGIndex/8f3a8827f03823ba4e8ea2f340c03066f185dd54/js/flv.min.js"></script>');document.write('<script src="//rawcdn.githack.com/curious-harshit/IBGIndex/ed9d21b3c8902e6992471caea1eade37d6a59fbf/js/DPlayer.min.js"></script>');document.write('<script src="//rawcdn.githack.com/curious-harshit/IBGIndex/ed9d21b3c8902e6992471caea1eade37d6a59fbf/js/markdown-it.min.js"></script>');document.write("<style>.mdui-appbar .mdui-toolbar{height:56px;font-size:1pc}.mdui-toolbar>i{opacity:.5}.mdui-toolbar>i{padding:0}.mdui-toolbar>a:hover,a.active,a.mdui-typo-headline{opacity:1}.mdui-container{max-width:980px}.mdui-list-item{transition:none}.mdui-list>.th{background-color:initial}.mdui-list-item>a{width:100%;line-height:3pc}.mdui-list-item{margin:2px 0;padding:0}.mdui-toolbar>a:last-child{opacity:1}@media screen and (max-width:980px){.mdui-list-item .mdui-text-right{display:none}.mdui-container{width:100%!important;margin:0}}</style>");if(UI.dark_mode){document.write("<style>* {box-sizing: border-box}body{color:rgba(255,255,255,.87);background-color:#1E252F}.mdui-theme-primary-${UI.main_color} .mdui-color-theme{background-color:#1E252F!important} .nexmoe-item{background-color: #ffffff0d!important;box-shadow:0 0.2em 1em rgb(0 0 0 / 30%)!important} .mdui-list-item{border: 1px solid rgb(255 255 255 / 10%)!important} .mdui-select-menu{box-shadow: 0 0.2em 1em rgba(100, 100, 100, 0.2)!important} .mdui-text-color-blue-grey-500{color: #e3e4e5 !important} .mdui-textfield-label{color: rgba(255, 255, 255, .54)!important}</style>");}
if(UI.hide_madewithlove){document.write("<style>.dummyclass{display: none!important}</style>");}
if(UI.helpURL===''){document.write("<style>.dummyclass2{display: none!important}</style>");}
...
<div class="mdui-container">
  ...
  <div class="mdui-center mdui-text-center mdui-text-color-blue-grey-5001 dummyclass" style="margin-bottom: 20px; background-color:#ffffff0d!important; box-shadow: 0 0.2em 1em rgb(0 0 0 / 30%)!important; padding: 1px !important"><p style="font-size:20px">Developed by <a href="https://instagram.com/curious_harshit">curious_harshit</a></p></div>
</div>
	`;$("body").html(html);}
...
function render(path){if(path.indexOf("?")>0){path=path.substr(0,path.indexOf("?"));}
$("title").html(`${document.siteName}`);nav(path);var reg=/\/\d+:$/g;if(window.MODEL.is_search_page){window.scroll_status={event_bound:!1,loading_lock:!1};render_search_result_list();}else if(path.match(reg)||path.substr(-1)=="/"){window.scroll_status={event_bound:!1,loading_lock:!1};list(path);}else{file(path);}}
function nav(path){var model=window.MODEL;var html="";var cur=window.current_drive_order||0;var names=window.drive_names;html+=`<select class="mdui-select" onchange="window.location.href=this.value" mdui-select style="overflow:visible;">`;names.forEach((name,idx)=>{html+=`<option value="/${idx}:/"  ${
idx===cur?'selected="selected"':""
} >${name}</option>`;});html+=`</select>`;html+=`<a href="/${cur}:/" class="mdui-typo-headline folder">${document.siteName}</a>`;if(!model.is_search_page){var arr=path.trim("/").split("/");var p="/";if(arr.length>1){arr.shift();for(i in arr){var n=arr[i];n=decodeURI(n);p+=n+"/";if(n==""){break;}
html+=`<i class="mdui-icon material-icons mdui-icon-dark folder" style="margin:0;">chevron_right</i><a class="folder" href="/${cur}:${p}">${n}</a>`;}}}
var search_text=model.is_search_page?model.q||"":"";const isMobile=Os.isMobile;var search_bar=`<div class="mdui-toolbar-spacer"></div>
...
model.is_search_page?"mdui-textfield-expanded":""
        ...
        </button>`;if(model.root_type<2){html+=search_bar;}
$("#nav").html(html);mdui.mutation();mdui.updateTextFields();}
function requestListPath(path,params,resultCallback,authErrorCallback){var p={password:params.password||null,page_token:params.page_token||null,page_index:params.page_index||0,};$.post(path,p,function(data,status){var res=jQuery.parseJSON(data);if(res&&res.error&&res.error.code=="401"){if(authErrorCallback)authErrorCallback(path);}else if(res&&res.data){if(resultCallback)resultCallback(res,path,p);}});}
function requestSearch(params,resultCallback){var p={q:params.q||null,page_token:params.page_token||null,page_index:params.page_index||0,};$.post(`/${window.current_drive_order}:search`,p,function(data,status){var res=jQuery.parseJSON(data);if(res&&res.data){if(resultCallback)resultCallback(res,p);}});}
function list(path){var content=`
	 <div class="mdui-row"> 
	  <ul class="mdui-list"> 
	...
	`;$("#content").html(content);var password=localStorage.getItem("password"+path);$("#list").html(`<div class="mdui-progress"><div class="mdui-progress-indeterminate"></div></div>`);$("#readme_md").hide().html("");$("#head_md").hide().html("");function successResultCallback(res,path,prevReqParams){$("#list").data("nextPageToken",res.nextPageToken).data("curPageIndex",res.curPageIndex);$("#spinner").remove();if(res.nextPageToken===null){$(window).off("scroll");window.scroll_status.event_bound=!1;window.scroll_status.loading_lock=!1;append_files_to_list(path,res.data.files);}else{append_files_to_list(path,res.data.files);if(window.scroll_status.event_bound!==!0){$(window).on("scroll",function(){var scrollTop=$(this).scrollTop();var scrollHeight=getDocumentHeight();var windowHeight=$(this).height();if(scrollTop+windowHeight>scrollHeight-(Os.isMobile?130:80)){if(window.scroll_status.loading_lock===!0){return;}
window.scroll_status.loading_lock=!0;$(`<div id="spinner" class="mdui-spinner mdui-spinner-colorful mdui-center"></div>`).insertBefore("#readme_md");mdui.updateSpinners();let $list=$("#list");requestListPath(path,{password:prevReqParams.password,page_token:$list.data("nextPageToken"),page_index:$list.data("curPageIndex")+1,},successResultCallback,null);}});window.scroll_status.event_bound=!0;}}
if(window.scroll_status.loading_lock===!0){window.scroll_status.loading_lock=!1;}}
requestListPath(path,{password:password},successResultCallback,function(path){$("#spinner").remove();var pass=prompt("Directory encrypted, Please enter the Password","");localStorage.setItem("password"+path,pass);if(pass!=null&&pass!=""){list(path);}else{history.go(-1);}});}
function append_files_to_list(path,files){var $list=$("#list");var is_lastpage_loaded=null===$list.data("nextPageToken");var is_firstpage="0"==$list.data("curPageIndex");html="";let targetFiles=[];for(i in files){var item=files[i];var p=path+item.name+"/";if(item.size==undefined){item.size="";}
item.modifiedTime=utc2beijing(item.modifiedTime);item.size=formatFileSize(item.size);if(item.mimeType=="application/vnd.google-apps.folder"){html+=`<li class="mdui-list-item mdui-ripple"><a href="${p}" class="folder">
...
if(targetFiles.length>0){let old=localStorage.getItem(path);let new_children=targetFiles;if(!is_firstpage&&old){let old_children;try{old_children=JSON.parse(old);if(!Array.isArray(old_children)){old_children=[];}}catch(e){old_children=[];}
new_children=old_children.concat(targetFiles);}
localStorage.setItem(path,JSON.stringify(new_children));}
$list.html(($list.data("curPageIndex")=="0"?"":$list.html())+html);if(is_lastpage_loaded){$("#count").removeClass("mdui-hidden").find(".number").text($list.find("li.mdui-list-item").length);}}
function render_search_result_list(){var content=`
...
window.scroll_status.loading_lock=!0;$(`<div id="spinner" class="mdui-spinner mdui-spinner-colorful mdui-center"></div>`).insertBefore("#readme_md");mdui.updateSpinners();let $list=$("#list");requestSearch({q:window.MODEL.q,page_token:$list.data("nextPageToken"),page_index:$list.data("curPageIndex")+1,},searchSuccessCallback);}});window.scroll_status.event_bound=!0;}}
if(window.scroll_status.loading_lock===!0){window.scroll_status.loading_lock=!1;}}
requestSearch({q:window.MODEL.q},searchSuccessCallback);}
function append_search_result_to_list(files){var $list=$("#list");var is_lastpage_loaded=null===$list.data("nextPageToken");html="";for(i in files){var item=files[i];if(item.size==undefined){item.size="";}
item.modifiedTime=utc2beijing(item.modifiedTime);item.size=formatFileSize(item.size);if(item.mimeType=="application/vnd.google-apps.folder"){html+=`<li class="mdui-list-item mdui-ripple"><a id="${item["id"]}" onclick="onSearchResultItemClick(this)" class="folder">
	            <div class="mdui-col-xs-12 mdui-col-sm-7 mdui-text-truncate" title="${item.name}">
	            <i class="mdui-icon material-icons">folder_open</i>
	              ${item.name}
	            </div>
	        ...
	        </li>`;}else{var c="file";var ext=item.name.split(".").pop().toLowerCase();if("|html|php|css|go|java|js|json|txt|sh|md|mp4|webm|avi|bmp|jpg|jpeg|png|gif|m4a|mp3|flac|wav|ogg|mpg|mpeg|mkv|rm|rmvb|mov|wmv|asf|ts|flv|".indexOf(`|${ext}|`)>=0){c+=" view";}
...
$list.html(($list.data("curPageIndex")=="0"?"":$list.html())+html);if(is_lastpage_loaded){$("#count").removeClass("mdui-hidden").find(".number").text($list.find("li.mdui-list-item").length);}}
function onSearchResultItemClick(a_ele){var me=$(a_ele);var can_preview=me.hasClass("view");var cur=window.current_drive_order;var dialog=mdui.dialog({title:"",content:'<div class="mdui-text-center mdui-typo-title mdui-m-b-1">Getting Target Path...</div><div class="mdui-spinner mdui-spinner-colorful mdui-center"></div>',history:!1,modal:!0,closeOnEsc:!0,});mdui.updateSpinners();$.post(`/${cur}:id2path`,{id:a_ele.id},function(data){if(data){dialog.close();var href=`/${cur}:${data}${can_preview?"?a=view":""}`;dialog=mdui.dialog({title:'<i class="mdui-icon material-icons"></i>Target Path',content:`<a href="${href}">${data}</a>`,history:!1,modal:!0,closeOnEsc:!0,buttons:[{text:"Open in same tab",onClick:function(){window.location.href=href;},},{text:"Open in new tab",onClick:function(){window.open(href);},},{text:"Cancel"},],});return;}
dialog.close();dialog=mdui.dialog({title:'<i class="mdui-icon material-icons">&#xe811;</i>Failed to get the target path',content:"It may be because this item does not exist in the Folder! It may also be because the file [Shared with me] has not been added to Personal Drive!",history:!1,modal:!0,closeOnEsc:!0,buttons:[{text:"WTF ???"}],});});}
function get_file(path,file,callback){var key="file_path_"+path+file.modifiedTime;var data=localStorage.getItem(key);if(data!=undefined){return callback(data);}else{$.get(path,function(d){localStorage.setItem(key,d);callback(d);});}}
function file(path){var name=path.split("/").pop();var ext=name.split(".").pop().toLowerCase().replace(`?a=view`,"").toLowerCase();if("|html|php|css|go|java|js|json|txt|sh|md|".indexOf(`|${ext}|`)>=0){return file_code(path);}
if("|mp4|webm|avi|".indexOf(`|${ext}|`)>=0){return file_video(path);}
if("|mpg|mpeg|mkv|rm|rmvb|mov|wmv|asf|ts|flv|".indexOf(`|${ext}|`)>=0){return file_video(path);}
if("|mp3|flac|wav|ogg|m4a|".indexOf(`|${ext}|`)>=0){return file_audio(path);}
if("|bmp|jpg|jpeg|png|gif|".indexOf(`|${ext}|`)>=0){return file_image(path);}
if("pdf"===ext)return file_pdf(path);}
function file_code(path){var type={html:"html",php:"php",css:"css",go:"golang",java:"java",js:"javascript",json:"json",txt:"Text",sh:"sh",md:"Markdown",};var name=path.split("/").pop();var ext=name.split(".").pop().toLowerCase();var href=window.location.origin+path;var content=`
<div class="mdui-container">
<pre id="editor" ></pre>
</div>
...
var editor=ace.edit("editor");editor.setTheme("ace/theme/ambiance");editor.setFontSize(18);editor.session.setMode("ace/mode/"+code_type);editor.setOptions({enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0,maxLines:Infinity,});});}
...
function file_video(path){const url=window.location.origin+path;let player_items=[{text:"MXPlayer(Free)",href:`intent:${url}#Intent;package=com.mxtech.videoplayer.ad;S.title=${path};end`,},{text:"MXPlayer(Pro)",href:`intent:${url}#Intent;package=com.mxtech.videoplayer.pro;S.title=${path};end`,},{text:"nPlayer",href:`nplayer-${url}`},{text:"VLC",href:`vlc://${url}`},{text:"PotPlayer",href:`potplayer://${url}`},].map((it)=>`<li class="mdui-menu-item"><a href="${it.href}" class="mdui-ripple">${it.text}</a></li>`).join("");player_items+=`<li class="mdui-divider"></li>
      ...
      <ul class="mdui-menu" id="player-items">${player_items}</ul>`;const content=`
<div class="mdui-container-fluid">
	<br>
...
<a href="${url}" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent"><i class="mdui-icon material-icons">file_download</i></a>
	`;$("#content").html(content);$("#copy-link").on("click",()=>{copyToClipboard(url);mdui.snackbar("Copied to clipboard!");});const dp=new DPlayer({container:document.getElementById("dplayer"),loop:false,screenshot:true,preload:"auto",video:{quality:[{url:url,type:"normal"}],autoplay:true,defaultQuality:0,},});}
...
function file_pdf(path){const url=window.location.origin+path;const inline_url=`${url}?inline=true`;const file_name=decodeURI(path.slice(path.lastIndexOf("/")+1,path.length));var content=`
...
function file_image(path){var url=window.location.origin+path;const currentPathname=window.location.pathname;const lastIndex=currentPathname.lastIndexOf("/");const fatherPathname=currentPathname.slice(0,lastIndex+1);let target_children=localStorage.getItem(fatherPathname);let targetText="";if(target_children){try{target_children=JSON.parse(target_children);if(!Array.isArray(target_children)){target_children=[];}}catch(e){console.error(e);target_children=[];}
if(target_children.length>0&&target_children.includes(path)){let len=target_children.length;let cur=target_children.indexOf(path);let prev_child=cur-1>-1?target_children[cur-1]:null;let next_child=cur+1<len?target_children[cur+1]:null;targetText=`
            <div class="mdui-container">
...
<a href="${url}" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent"><i class="mdui-icon material-icons">file_download</i></a>
    `;$("#content").html(content);$("#leftBtn, #rightBtn").click((e)=>{let target=$(e.target);if(["I","SPAN"].includes(e.target.nodeName)){target=$(e.target).parent();}
const filepath=target.attr("data-filepath");const direction=target.attr("data-direction");file(filepath);});}
function utc2beijing(utc_datetime){var T_pos=utc_datetime.indexOf("T");var Z_pos=utc_datetime.indexOf("Z");var year_month_day=utc_datetime.substr(0,T_pos);var hour_minute_second=utc_datetime.substr(T_pos+1,Z_pos-T_pos-1);var new_datetime=year_month_day+" "+hour_minute_second;timestamp=new Date(Date.parse(new_datetime));timestamp=timestamp.getTime();timestamp=timestamp/1000;var unixtimestamp=timestamp+8*60*60;var unixtimestamp=new Date(unixtimestamp*1000);var year=1900+unixtimestamp.getYear();var month="0"+(unixtimestamp.getMonth()+1);var date="0"+unixtimestamp.getDate();var hour="0"+unixtimestamp.getHours();var minute="0"+unixtimestamp.getMinutes();var second="0"+unixtimestamp.getSeconds();return(year+
"-"+
...
function formatFileSize(bytes){if(bytes>=1000000000){bytes=(bytes/1000000000).toFixed(2)+" GB";}else if(bytes>=1000000){bytes=(bytes/1000000).toFixed(2)+" MB";}else if(bytes>=1000){bytes=(bytes/1000).toFixed(2)+" KB";}else if(bytes>1){bytes=bytes+" bytes";}else if(bytes==1){bytes=bytes+" byte";}else{bytes="";}
return bytes;}
String.prototype.trim=function(char){if(char){return this.replace(new RegExp("^\\"+char+"+|\\"+char+"+$","g"),"");}
return this.replace(/^\s+|\s+$/g,"");};function markdown(el,data){if(window.md==undefined){window.md=window.markdownit();markdown(el,data);}else{var html=md.render(data);$(el).show().html(html);}}
window.onpopstate=function(){var path=window.location.pathname;render(path);};$(function(){init();var path=window.location.pathname;render(path);});
